...
\dd{francy: it seems like the training $x_i$'s must be in here somewhere.  are they implictly in $\Omega$?   also, where is $f\left(y_{n+1}|x_{n+1},\Omega\right)$ defined?  where is \ref{eq:base}? }
\begin{equation*}
